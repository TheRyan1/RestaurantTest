...
namespace reactnet.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(RoleManager<IdentityRole> roleManager,ApplicationDbContext applicationDb, UserManager<ApplicationUser> userManager, IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                ...
                UserModel Result = new UserModel(currentUser.user);
        ...
        public async Task<IActionResult> Post([FromBody] UserModel model)
        {
            ...
            try
            {
                ...
                if (userResult.Succeeded)
                {
                    ...
                    {
                        return StatusCode(500, new ResultModel() { Message = roleResult.Errors.FirstOrDefault().Description });
                    }
