...
namespace reactnet.Controllers
{
    ...
    public class RestaurantController : ControllerBase
    {
        ...
        public RestaurantController(ApplicationDbContext dbContext) => _dbContenxt = dbContext;
        ...
        public async Task<ActionResult<List<Restaurant>>> Get()
        {
            ...
            return await _dbContenxt.Restuarant.Where(x => x.UserID == user.Id).Include(x=>x.Reservations).Include(x=>x.Meals).ToListAsync();
        }
